...
async def _classify(state: RetailState) -> RetailState:
    base_url = os.getenv("RETAIL_LLM_BASE_URL")
    api_key = os.getenv("RETAIL_LLM_API_KEY")
    model = os.getenv("RETAIL_LLM_MODEL")
    timeout = float(os.getenv("RETAIL_LLM_TIMEOUT", "60"))
